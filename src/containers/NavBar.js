  ...
  if (isDoctor === false) {
    return (
      <div>
        ...
        <button className="bg-blue-500 px-2 rounded text-white" type="submit" onClick={handleSubmit}>Signout</button>
      </div>
    );
    ...
    return (
      <div>
        ...
        <button className="bg-blue-500" type="submit" onClick={handleSubmit}>Signout</button>
      </div>
    );
  } return (
    <div>
